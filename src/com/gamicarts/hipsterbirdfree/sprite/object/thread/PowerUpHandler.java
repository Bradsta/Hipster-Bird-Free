package com.gamicarts.hipsterbirdfree.sprite.object.thread;
            ...
            while (game.dodgeBird != null
                ...
                for (PowerUpData pud : PowerUpData.values()) {
                    if (Utility.random(1, 5000) <= pud.getChance()) {
                        Utility.playSound(R.raw.powerup);
                        game.dodgeBird.getActivePowerUps().add(new PowerUp(pud, new Point(Utility.random(50, HipsterBirdFree.SCREEN_WIDTH - 50), Utility.random(50, HipsterBirdFree.SCREEN_HEIGHT - 50))));
                    }
                }
