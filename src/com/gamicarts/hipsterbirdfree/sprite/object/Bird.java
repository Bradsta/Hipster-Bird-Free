package com.gamicarts.hipsterbirdfree.sprite.object;

import android.content.res.Resources;
import android.graphics.*;
import com.gamicarts.hipsterbirdfree.HipsterBirdFree;
import com.gamicarts.hipsterbirdfree.sprite.component.BirdComponent;
import com.gamicarts.hipsterbirdfree.sprite.data.Accessory;
import com.gamicarts.hipsterbirdfree.sprite.data.BirdData;
import com.gamicarts.hipsterbirdfree.sprite.data.BirdPart;
import com.gamicarts.hipsterbirdfree.sprite.data.BirdState;
...
public class Bird {
    ...
    private BirdState birdState = BirdState.DEFAULT_STATE;
    ...
    private RectF getBodyRect() {
        this.bodyRect.left = this.birdData.getBirdComponentSet().getBody().getSpriteComponent().getPositionedLocation().x + this.birdLocation.x;
        ...
        //Component bitmap for body is sometimes null?
