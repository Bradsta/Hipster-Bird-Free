...
import com.gamicarts.hipsterbirdfree.game.DodgeBird;
...
public class Game implements GameTask {
    ...
    public void run() {
        ...
        hipsterBird.allocateBird(HipsterBirdFree.RESOURCES);

        try {
            while (HipsterBirdFree.GAME_HANDLER.isActive()) {
    ...
    private Thread cloudThread = new Thread() {
        ...
        public void run() {
            ...
            for (Sprite cloud : clouds) {
                ...
                cloud.setLocation(new Point(Utility.random(0, HipsterBirdFree.SCREEN_WIDTH), Utility.random(0, HipsterBirdFree.SCREEN_HEIGHT)));
            }
                ...
                while (HipsterBirdFree.GAME_HANDLER.isActive()) {
                    ...
                    for (Sprite cloud : clouds) {
                        ...
                        if (cloud.getBitmap() != null
                            ...
                            cloud.setLocation(new Point(HipsterBirdFree.SCREEN_WIDTH, Utility.random(0, HipsterBirdFree.SCREEN_HEIGHT)));
                            cloud.setSpeed(Utility.random(minSpeed, maxSpeed));
                        }
                    }
