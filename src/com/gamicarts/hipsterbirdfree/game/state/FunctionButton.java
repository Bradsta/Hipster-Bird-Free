package com.gamicarts.hipsterbirdfree.game.state;
...
public enum FunctionButton {
    ...
    public void configure() {
        ...
        this.paintString = new PaintString(buttonText, HipsterBirdFree.HOBO, Color.WHITE, Utility.getXRatio(this.fontSize), point);
