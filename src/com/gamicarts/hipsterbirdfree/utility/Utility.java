package com.gamicarts.hipsterbirdfree.utility;
...
public class Utility {
    ...
    public static float getWidthRatio() {
        return ((float) HipsterBirdFree.SCREEN_WIDTH / (float) HipsterBirdFree.STANDARD_SCREEN_WIDTH);
    }
    ...
    public static float getHeightRatio() {
        return ((float) HipsterBirdFree.SCREEN_HEIGHT / (float) HipsterBirdFree.STANDARD_SCREEN_HEIGHT);
    }
    ...
    public static void playSound(int ID) {
        HipsterBirdFree.soundPool.play(HipsterBirdFree.soundPoolMap.get(ID), 1f, 1f, 1, 0, 1f);
    }
